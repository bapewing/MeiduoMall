...
SECRET_KEY = '!r%+_&gfs=ytu_$6bi#s9*!ks+7!=qc(427ohx*x(hskz=5oi-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['api.meiduo.site', '127.0.0.1', 'www.meiduo.site', '172.16.10.133']
...
CRONJOBS = [
    ...
    ('*/1 * * * *', 'contents.crons.generate_static_index_html',
     '>> /Users/wxy/Desktop/MeiduoMall/meiduo_mall/logs/crontab.log')
]
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = '350508037@qq.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'qhtilojzeiawbiij'
# bug: QQ邮箱发送时需要设置为True
# 与SMTP服务器通信时，是否启动TLS链接(安全链接)。默认是false
EMAIL_USE_TLS = True
# 收件人看到的发件人
EMAIL_FROM = '美多商城<350508037@qq.com>'
